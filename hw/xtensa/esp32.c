...
static void esp32_machine_init_spi_flash(Esp32SocState *ss, BlockBackend *blk)
{
    ...
    {
    case 2 * 1024 * 1024:
        flash_chip_model = "w25x16";
        break;
    case 4 * 1024 * 1024:
        flash_chip_model = "gd25q32";
        break;
    case 8 * 1024 * 1024:
        flash_chip_model = "gd25q64";
        break;
    case 16 * 1024 * 1024:
        flash_chip_model = "is25lp128";
        break;
    default:
        error_report("Error: only 2, 4, 8, 16 MB flash images are supported");
        return;
    }
    ...
    if (load_elf_filename)
    {
        ...
        if (elf_entry != XCHAL_RESET_VECTOR_PADDR)
        {
            ...
            uint8_t boot[] = {
                ...
                p[1],
                p[2],
                p[3], /* .literal elf_entry */
                      /* 1: */
                0x01,
                0xff,
                0xff, /* l32r a0, elf_entry */
                0xa0,
                0x00,
                0x00, /* jx   a0 */
            };
